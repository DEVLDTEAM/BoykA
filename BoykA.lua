...
os.execute('wget https://raw.githubusercontent.com/BOYKA-DeV/BOYKA-DeV/main/BoykA.lua')
os.execute('wget https://raw.githubusercontent.com/BOYKA-DeV/BOYKA-DeV/main/start.lua')
dofile('BoykA.lua')  
return false
end
if text == "راسلني" then
